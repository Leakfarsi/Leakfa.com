<?php $title = 'تأیید ایمیل';
    ...
    <div class="container" style="max-width: 600px;margin: 10px auto;">
        ...
        <div class="card text-center">
            <div class="card-body">
                <h5 class="card-title">ممکن است اشتراک لغو شده باشد، لطفا <a href="/notify.php">دوباره مشترک شوید</a> اگر اشتراک لغو نشده و این پیام به طور مکرر ظاهر می شود، لطفاً مدیریت را مطلع کنید.</h5>
                <a href="/" class="btn btn-dark">بازگشت به خانه</a>
            </div>
        </div>
        <?php
